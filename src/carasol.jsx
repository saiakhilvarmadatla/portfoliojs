...
import { 
    ContactShadows, useContextBridge 
} from "@react-three/drei";
import { 
    A11y, useA11y, A11yAnnouncer, 
    useUserPreferences, A11ySection, 
            ...
            {["sphere", "pyramid", "donut", "octahedron", "icosahedron"].map((name, i) => (
                <A11y key={name} role="content" description={`a ${name}`} tabIndex={-1} hidden={snap.active !== i}>
                    <Shape
                        ...
                        position={
                            [
                                radius * Math.cos(i * ((Math.PI * 2) / 5)), 0, 
            ...
            <ContextBridge>
                ...
                <group position-y={2}>
                    <A11ySection
                        ...
                        description="This carousel contains 5 shapes"
                    >
                        <Nav left />
