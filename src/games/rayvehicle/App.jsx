...
const Letter = (props) => {
  ...
  const font = useLoader(THREE.FontLoader, '/fonts/IBM_Plex_Serif_Bold.json');

  const config = useMemo(() => ({
      font, size: 1.5, height: 0.4,
      curveSegments: 24, bevelEnabled: false,
      bevelThickness: 0, bevelSize: 0.3,
...
export default function RayVehicle() {
